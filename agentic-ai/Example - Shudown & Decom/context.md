To demonstrate the automation workflow:
...
Once the change status is validated and approved, the workflow sequentially executes two custom APIs: first, shutdown_linux to safely power down the servers, followed by decom_linux to decommission the systems. ( Execute Decom workflow to update your CMDB)
